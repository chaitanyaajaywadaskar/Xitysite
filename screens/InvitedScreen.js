            ...
            <View>
                ...
                <ScrollView>
                    ...
                    <View style={styles.styleCenter}>
                        ...
                        <Spacer size={size.sm} />
                        <Text style={styles.textStyle}>603103 Kelambakkam Pin Code {'\n'} Coming Soon</Text>
                        ...
                        {/* <View>
                            <View style={{ width: responsiveWidth(50), alignSelf: 'center', flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 15 }}>
                        ...
                        </Toucha<View style={{ flexDirection: 'row', alignSelf: 'center' }}>
