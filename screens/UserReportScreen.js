...
const UserReportLogScreen = ({ navigation }) => {
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{ backgroundColor: '#EFF5FF' }}>
                <View style={styles.styleCenter}>
                    ...
                    <View style={{ height: 50 }}>
                        <ImageTextInput hint='Specify the issue you are facing' isEmail={true}></ImageTextInput>
                    </View>
                    <Spacer size={size.sm} />
                    ...
                    <View style={{ alignItems: 'center', flexDirection: 'row', alignSelf: 'center' }}>
                        ...
                        <Spacer size={size.sh} />
                        <Text style={styles.blueText} onPress={() => { navigation.navigate('UserLogin') }}>Sign In</Text>
                    </View>
                    <Spacer size={size.xxxlg} />
...
export default UserReportLogScreen
